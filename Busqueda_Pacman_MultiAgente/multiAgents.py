...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        def agenteMAX(state, depth):
            ...
            # Establecemos la puntuacion en menos infinito para obtener una puntuación +alta
            ...
            for accion in acciones:
                ...
                # Comprobación de cual es la mejor puntuación
            ...
            if depth == 0:
                return mejorAccion
            #En caso contrario devolver la mejor puntuación
            else:
        ...
        def agenteMIN(state, depth, ghost):
            ...
            # Se establece la puntuacion en menos infinito para obtener una puntuación +alta
            mejorPuntuacion = float("inf")
...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def agenteMIN(self, state, depth, ghost, alpha, beta):
        ...
        # Se establece la puntuacion en infinito para obtener una puntuación + baja
        mejorPuntuacion = float("inf")
